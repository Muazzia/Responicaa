  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-full h-[270px] overflow-hidden flex justify-center items-center">
          <img
        ...
        <div className="mt-7">
          <p className="text-[40px] my-5 text-center font-semibold">
          ...
          <div className="mt-5">
            <p className="text-[40px] text-center text-primary font-semibold">
          ...
          <div className="my-10">
            <div>
              <p className="text-[48px] font-semibold mb-5">WHO WE ARE?</p>
              <div className="flex gap-[50px]">
                <div>
                  <p className="text-black/60 text-[20px]">
      ...
      <div className="max-w-7xl mx-auto mt-10">
        <div className="w-full flex justify-between items-center">
          <div>
            <p className="text-[48px] font-semibold leading-14 mb-5">
              Global Customer <br /> Services Provider
            </p>
            <p className="text-black/60 text-[14px] mb-5">
            ...
            <div className="bg-primary text-white w-fit px-4 py-2 rounded-lg">
              Get in Touch
            </div>
          </div>
          <div>
            <div className="w-[740px] h-[475px] overflow-hidden">
              <img
  ...
  return (
    <div>
      ...
      <div className="mt-5 space-y-5">
        <div>
          <p className="text-[30px] font-semibold ">Customer Support</p>
        ...
        <div>
          <p className="text-[30px] font-semibold ">TeleSales</p>
          <div className="text-black/60 mt-2">
            <p>
        ...
        <div>
          <p className="text-[30px] font-semibold ">Technical Support</p>
          <div className="text-black/60 mt-2">
            <p>
        ...
        <div>
          <p className="text-[30px] font-semibold ">Lead Generation</p>
          <div className="text-black/60 mt-2">
            <p>
        ...
        <div>
          <p className="text-[30px] font-semibold ">Quality Assurance</p>
          <div className="text-black/60 mt-2">
            <p>
        ...
        <div>
          <p className="text-[30px] font-semibold ">Truck Dispatch</p>
          <div className="text-black/60 mt-2">
            <p>
