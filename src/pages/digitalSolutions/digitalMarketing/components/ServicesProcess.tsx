...
export const ServiceProcess = ({ steps }: { steps: Step[] }) => {
  return (
    <div className="relative mt-8">
      <div className="hidden md:block absolute left-1/2 h-full border-2 border-red-200"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {steps.map((step, index) => (
          ...
          >
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-red-700 text-white w-8 h-8 rounded-full flex items-center justify-center">
              {index + 1}
            </div>
