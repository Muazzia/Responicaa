...
const boxData = [
  {
    ...
    icon: (
      <FaHeadset className="text-3xl md:text-4xl  text-white transition-all cursor-pointer flex-shrink-0 min-w-[2rem]" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaPhoneAlt className="text-3xl md:text-4xl  text-white transition-all cursor-pointer flex-shrink-0 min-w-[2rem]" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaCheckCircle className="text-3xl md:text-4xl  text-white transition-all cursor-pointer flex-shrink-0 min-w-[2rem]" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaHome className="text-3xl md:text-4xl  text-white transition-all cursor-pointer flex-shrink-0 min-w-[2rem]" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaBolt className="text-3xl md:text-4xl  text-white transition-all cursor-pointer flex-shrink-0 min-w-[2rem]" />
    ),
    ...
    <>
      <div className="px-4 md:px-10 xl:px-0 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 py-10 md:py-28 gap-8 md:gap-4">
        <div className="flex flex-col gap-6 md:gap-8 order-first">
          <h1 className="text-4xl md:text-6xl font-bold text-[#E07A3A]">
            BPO Services
          </h1>
      ...
      <div className="max-w-full lg:max-w-[80%] xl:max-w-6xl mx-auto px-4 sm:px-6">
        <div className="bg-gradient-to-b from-[#E07A3A] to-[#C0602D] text-center py-8 md:py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-4 md:p-10 rounded-sm gap-4 md:gap-8 lg:gap-10">
          {boxData.map((box) => (
            <div key={box.id} className="flex gap-3 md:gap-4 items-start">
              ...
              <div className="text-left">
                <Link
                  to={box.url}
                  className="text-xs font-semibold hover:text-[#FFD7BE] text-white transition-all cursor-pointer mb-2 md:mb-1"
                >
                  {box.title}
                </Link>
