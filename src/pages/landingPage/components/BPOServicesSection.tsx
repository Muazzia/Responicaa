      ...
      <div className="flex flex-col gap-6 md:gap-8 order-first">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-base leading-relaxed">
            ...
            outsourcing solutions (BPO). It will streamline your operations from
            data input to BPO Customer Service, allowing you to concentrate on
            the main aspects of business expansion. <br />
            <br />
            To achieve your strategic goals, we believe in boosting output,
            boosting efficiency, and most importantly, attaining achievement for
            your objectives in International BPO.
          </p>
        </div>
      </div>
